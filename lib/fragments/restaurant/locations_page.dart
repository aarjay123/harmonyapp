            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Failed to load map', style: theme.textTheme.titleMedium, textAlign: TextAlign.center),
...
class RestaurantLocationsPage extends StatelessWidget {
  ...
  // A non-embedded "viewer" URL is better for a fullscreen experience.
  final String _mapFullscreenUrl = 'https://www.google.com/maps/d/viewer?mid=1uifQD-IGknh0jPlri0xvZJ6WTnUOt2k';
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Icon(Icons.pin_drop_rounded, size: 36, color: colorScheme.primary),
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Open Map Fullscreen'),
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => FullscreenWebViewPage(
                          url: _mapFullscreenUrl,
                          title: 'Our Locations',
                        ),
                      ),
                    );
                ...
                Expanded(
                  child: Card(
                    ...
                    child: InteractiveWebView(url: _mapEmbedUrl),
                  ),
                ),
              ],
            ),
